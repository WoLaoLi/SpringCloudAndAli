...
public class OrderController {
    ...
    public CommonResult<Payment> create(@RequestParam Payment payment){
    ...
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id){
        ResponseEntity<CommonResult> forEntity = restTemplate.getForEntity(PAYMENT_URL + "/payment/getPaymentById/get/" + id, CommonResult.class);
